...
class TestStudentLists(TestCase):
    ...
    def test_add_then_remove_student_ensure_removed(self):
        test_class = ClassList(2)
    ...
    def test_add_students_remove_student_not_within_list(self):
    ...
    def test_add_students_check_enrollment(self):
        test_class = ClassList(2)
    ...
    def test_index_of_student_empty_list(self):
        test_class = ClassList(2)
        self.assertEqual('', str(test_class))
        self.assertIsNone(test_class.index_of_student('Student 1'))
    ...
    #Still working on
    def test_index_of_student_not_empty_list(self):
        test_class = ClassList(2)
        self.assertFalse('', str(test_class))
        self.assertIsNone(test_class.index_of_student('Student 1'))
